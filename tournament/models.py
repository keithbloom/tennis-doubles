...
class Team(models.Model):
    ...
    player2 = models.ForeignKey(Player, related_name='teams_as_player2', on_delete=models.CASCADE)
...
class Match(models.Model):
    ...
    def clean(self):
        ...
        sets = [(self.set1_team1, self.set1_team2),
                (self.set2_team1, self.set2_team2)]
